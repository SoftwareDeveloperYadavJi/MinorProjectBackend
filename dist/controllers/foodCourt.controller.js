...
export const addFoodCourt = async (req, res) => {
    try {
...
export const getFoodCourts = async (req, res) => {
    try {
...
export const removeFoodCourt = async (req, res) => {
    try {
...
export const getFoodCourtById = async (req, res) => {
    try {
        // @ts-ignore
